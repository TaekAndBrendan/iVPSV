...
## Tested Programs
Shor-read aligner: BWA-MEM (https://github.com/lh3/bwa), Bowtie2 (https://github.com/BenLangmead/bowtie2) and Minimap2 with SR (short genomic paried-end reads) and MD (output the MD tag) mode (https://github.com/lh3/minimap2)
Long-read aligner: Minimap2 MAB-PB, MAB-ONT and MD mode (https://github.com/lh3/minimap2)
